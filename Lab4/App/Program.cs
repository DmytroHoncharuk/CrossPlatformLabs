...
app.Command("version", versionCmd =>
{
    ...
    {
        Console.WriteLine("Author: Dmytro Honcharuk, IPZ-31");
...
app.Command("run", run =>
{
    ...
    run.Command("lab1", lab1 =>
    {
        ...
        lab1.OnExecute(() =>
        {
            ...
            {
                folderPath = Path.Combine("..", "AppFiles", "Lab1");
            }
    ...
    run.Command("lab2", lab2 =>
    {
        ...
        lab2.OnExecute(() =>
        {
            ...
            if (string.IsNullOrWhiteSpace(folderPath))
            {
                folderPath = Path.Combine("..", "AppFiles", "Lab2");
            }
    ...
    run.Command("lab3", lab3 =>
    {
        ...
        lab3.OnExecute(() =>
        {
            ...
            if (string.IsNullOrWhiteSpace(folderPath))
            {
                folderPath = Path.Combine("..", "AppFiles", "Lab3");
            }
